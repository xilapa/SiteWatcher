    ...
    internal partial class NotificationEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "SiteWatcher.Domain.Alerts.Entities.Notifications.Notification",
                typeof(Notification),
                baseEntityType);
            ...
            var emailId = runtimeEntityType.AddProperty(
                "EmailId",
                typeof(EmailId?),
                propertyInfo: typeof(Notification).GetProperty("EmailId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Notification).GetField("<EmailId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var alert = declaringEntityType.AddNavigation("Alert",
                runtimeForeignKey,
                onDependent: true,
                typeof(Alert),
                propertyInfo: typeof(Notification).GetProperty("Alert", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Notification).GetField("<Alert>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
